...
const NavbarDefault = [
  {
    ...
    children: [
      {
        id: uuid(),
        menuitem: "Student Login",
        // link: "/authentication/Student-sign-in",
