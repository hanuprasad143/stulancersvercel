                    ...
                    <div className="d-flex flex-row justify-content-between align-items-center">
                        ...
                        <div>
                            {mentor.allowFreeTrial ?
                                <Link href="#!" scroll={false} className="btn btn-outline-primary" onClick={() => setModalShow(true)}>Book a Free Trial</Link>
                                : <Link href="#!" scroll={false} className="btn btn-outline-secondary" onClick={() => setModalShow(true)}>Book Sessions</Link>}
                        </div>
                    </div>
                </div>
            </div>
