            ...
            <Row>
              ...
              <Col md={6} sm={12} className="mb-3">
                <Form.Group className="mb-3" controlId="formFirstName">
                  ...
                  <Form.Control type="text" placeholder="Pranathi" required />
                </Form.Group>
              </Col>
              ...
              <Col md={6} sm={12} className="mb-3">
                <Form.Group className="mb-3" controlId="formLastName">
                  ...
                  <Form.Control type="text" placeholder="Reddy" required />
                </Form.Group>
              </Col>
