            ...
            <Row className="align-items-center">
              <Col md={6}>
                <div className="">
                  ...
                  <h2 className="h1">What our Stulancers say</h2>
                  <p className="mb-0">
                    {" "}
                    Hear from <span className="text-dark"></span>
                    <span className="text-dark">Instructors</span>, and{" "}
                    <span className="text-dark">Mentors</span> in the learning
                    space about how Stulancers empowers them to provide quality
