...
const ClientPayment = () => {
  ...
  return (
    <ClientProfileLayout>
      {/* Geeks SEO settings  */}
      <GeeksSEO title=" Client Payment Methods " />
              ...
              <div className="d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 fs-6">Expires in 10/2026</p>
                  </div>
                </div>
                <div className="d-flex">
                  <span>
              ...
              <div className="d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 fs-6">Expires in 03/2026</p>
                  </div>
                </div>
                <div className="d-flex">
                  <ActionMenu />
              ...
              <div className="d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 fs-6">Expires in 07/2026</p>
                  </div>
                </div>
                <div className="d-flex">
                  <ActionMenu />
              ...
              <div className="d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 fs-6">Expires in 12/2026</p>
                  </div>
                </div>
                <div className="d-flex">
                  <ActionMenu />
