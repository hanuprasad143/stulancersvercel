...
// import widget/custom components
import { StatRightBadge, ApexCharts } from "widgets";
...
const InstructorPayment = () => {
  ...
  return (
    <ProfileLayout>
      {/* Geeks SEO settings  */}
      <GeeksSEO title="Instructor Payment Methods " />
      ...
      <Card className="border-0 mb-4">
        ...
        <Card.Body>
          ...
          <p className="mb-0">
            ...
            <span className="text-success">$1500</span> will be applied to your
            primary payment method on{" "}
            <span className="text-success">July 20, 2026.</span>
          </p>
        </Card.Body>
      </Card>
              ...
              <div className="d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 fs-6">Expires in 10/2027</p>
                  </div>
                </div>
                <div className="d-flex">
                  <span>
              ...
              <div className="d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 fs-6">Expires in 03/2028</p>
                  </div>
                </div>
                <div className="d-flex">
                  <ActionMenu />
              ...
              <div className="d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 fs-6">Expires in 07/2027</p>
                  </div>
                </div>
                <div className="d-flex">
                  <ActionMenu />
              ...
              <div className="d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 fs-6">Expires in 12/2027</p>
                  </div>
                </div>
                <div className="d-flex">
                  <ActionMenu />
