                  ...
                  <tr key={index}>
                    <td>
                      <div className="d-flex align-items-center">
                        {/* quiz img */}
                        <Link href="/marketing/instructor/quiz-single/">
                          {" "}
                          <Image
                            src={item.image}
                            alt=""
                        ...
                        <div className="ms-3">
                          <h4 className="mb-2">
                            <Link
                              href="/marketing/instructor/quiz-single/"
                          ...
                          <div>
                            ...
                            <Link
                              href="/marketing/instructor/quiz-result/"
                    ...
                    <td>
                      ...
                      <div>
                        ...
                        <Link href="#" className="ms-2 link-danger">
