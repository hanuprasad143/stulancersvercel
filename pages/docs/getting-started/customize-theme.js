        ...
        <Row>
          <Col md={12} xs={12}>
            <Row className="docs-example">
              <Col md={12} xs={12}>
                <div>
                  <h3 className="mb-0">Changing Color Variables</h3>
                  <br />
                  <p>
                    Here, we will go over how you can customize the theme/colors
                    in our template.
                    <br />
                    <br />
                    Theme&apos;s colors variables are defined in{" "}
                    <code>/styles/theme/_variables.scss</code> file, but
                    it&apos;s not preferable to modify this core style sheet
                    file. If you want to override values of these variables, you
                    can use below file i.e. <code>_user-variables.scss</code>.
                    To update primary colors to something else navigate to below
                    mentioned theme file and update value to desired colors in
                    themes you like.
                  </p>
                  File: <code>/styles/_user-variables.scss</code>
                  <p>
                    In order to demonstrate this, here is a code example you can
                    paste into <code>/styles/_user-variables.scss</code>, save
                    the file and check the result of customized colors.
                  </p>
                  <HighlightCode
                    className="py-3 ps-3"
                    code={newStyleVariables}
                  />
                </div>
              </Col>
              <Col md={12} xs={12}>
                ...
                <hr />
                <div>
                  <h3 className="mb-0">Changing Logo</h3>
                  <br />
                  <p>
                    Here, we will go over how you can change or replace
                    current/default branding by replacing the logo path.
                  </p>
                  File: <code>app.config.js</code>
                  <p>
                    Open the above mentioned file, located at sourcecode root
                    and modify urls for logo to change logo.
                  </p>
                  <code>Note :</code> <br />
              ...
              <Col md={12} xs={12}>
                ...
                <div>
                  <h3 className="mb-0">Changing Favicon</h3>
                  <br />
                  <p>
                    To change the favicon of the theme, you just need to replace
                    favicon.ico file located at below path.
                  </p>
