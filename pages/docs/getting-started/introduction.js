        ...
        <DocsInnerLayout links={introductionLinks} id="intro">
            <div className="docs-content mx-xxl-9">
                ...
                <PageHeadingDescription
                    title="Introduction"
                    description="A professional Geeks UI Next.js (page router) kit that comes with plenty of
                ...
                <Row>
                    <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                        <div className="mb-8" >
                            <p >
                                Geeks UI Next.js theme is built with the most popular front-end framework{' '}
                                <Link
                            ...
                            <p >
                                This doc will guide you to understand how GeeksUI-Next.js theme is
                ...
                <Row>
                    <Col xs={12} md={12}>
                        <div className="mb-8" id="setting-up">
                            ...
                            <p className="mb-0">
                                GeeksUI Next.js is built using modern development toolset. For setting up
                                local development you need core tool i.e. Node JS. <Link href="/docs/getting-started/environment-setup">Read More</Link>
                            </p>
                        </div>
                        <div className="mb-8" id="customize-theme">
                            <div className="mb-4">
                                ...
                                <p className="mb-0">
                                    ...
                                    customize your theme. <Link href="/docs/getting-started/customize-theme">Read More</Link>
                                </p>
                            </div>
                        </div>
                    </Col>
