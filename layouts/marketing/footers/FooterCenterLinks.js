				...
				<Row className="justify-content-center text-center align-items-center">
					<Col xxl={6} md={12} xs={12} className="px-0">
						...
						<Nav className='nav-footer justify-content-center'>
							...
							<span className="my-2 vr opacity-50"></span>
							<Link href="#" className='nav-link'>Affilliate</Link>
							<span className="my-2 vr opacity-50"></span>
							<Link href="#" className='nav-link'>Help</Link>
							<span className="my-2 vr opacity-50"></span>
							<Link href="#" className='nav-link'>Investors</Link>
							<span className="my-2 vr opacity-50"></span>
						</Nav>
					</Col>
				</Row>
				...
				<Row className="align-items-center">
					...
					<Col lg={7} md={6} xs={12} className="d-lg-flex justify-content-center">
						<Nav className="nav-footer">
							<Link className="nav-link ps-0" href="#">Privacy Policy</Link>
							<Link className="nav-link px-2 px-md-0" href="#">Cookie Notice</Link>
